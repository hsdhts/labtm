...
<div class="mb-3">
    ...
    <input type="number" class="form-control @error('harga') is-invalid @enderror" id="harga" placeholder="Harga" value="{{ old('harga') }}" name="harga">
    @error('harga')    
    <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
...
<div class="input-group mb-5">
    ...
    <input type="text" class="form-control bagian_form @error('satuan') is-invalid @enderror" aria-label="Satuan" name="satuan" value="{{ old('satuan') }}" id="satuan" readonly>
    @error('satuan')    
    <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
